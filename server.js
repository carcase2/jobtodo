...
MongoClient.connect(
  "mongodb+srv://carcase2:ka76062989@cluster0.9gddo.mongodb.net/?retryWrites=true&w=majority",
...
app.get("/edit/:id", function (요청, 응답) {
  db.collection("Job_List").findOne(
...
app.put("/edit", function (요청, 응답) {
  db.collection("Job_List").updateOne(
  ...
  function (요청, 응답) {
    ...
    db.collection("counter").findOne(
      ...
      function (에러, 결과) {
        ...
        db.collection("Job_List").insertOne(저장할것, function (에러, 결과) {
          console.log("저장됨");
    ...
    // 응답.redirect("/");
    setTimeout(() => {응답.redirect("/list");}, 100);
    // 응답.render("index.ejs");
